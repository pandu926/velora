...
const AGENT_IDS = ['market-analyst','yield-researcher','risk-officer','sentiment-analyst','protocol-analyst','onchain-analyst','technical-auditor','macro-analyst','quant-strategist']
const AGENT_NAMES: Record<string,string> = {'market-analyst':'Market','yield-researcher':'Yield','risk-officer':'Risk','sentiment-analyst':'Sentiment','protocol-analyst':'Protocol','onchain-analyst':'On-Chain','technical-auditor':'Auditor','macro-analyst':'Macro','quant-strategist':'Quant'}
const AGENT_COLORS: Record<string,{bg:string;border:string;text:string;glow:string;blob:string}> = {
